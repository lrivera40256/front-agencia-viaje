  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-travel-navy">Destinos Populares</CardTitle>
                <CardDescription>Los favoritos de nuestros viajeros</CardDescription>
              </div>
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    <div className="flex items-center gap-2">
                      <h4 className="font-semibold text-travel-navy">{destination.name}</h4>
                      <Badge variant="secondary" className="text-xs">
                        {destination.badge}
                      </Badge>
                    </div>
                    <p className="text-sm text-travel-ocean font-medium">{destination.price}</p>
            ...
            <div className="space-y-4">
              {recentActivity.map((activity, index) => (
                <div key={index} className="flex items-start space-x-3">
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="text-sm font-medium text-travel-navy">{activity.action}</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Button variant="outline" className="h-20 flex-col space-y-2 hover:bg-travel-ocean-light hover:border-travel-ocean">
