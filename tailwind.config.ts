    ...
    extend: {
      colors: {
        ...
        travel: {
          ...
          "ocean-light": "hsl(var(--travel-ocean-light))",
        ...
        auth: {
          gradient: {
            from: "hsl(var(--auth-gradient-from))",
            via: "hsl(var(--auth-gradient-via))",
            to: "hsl(var(--auth-gradient-to))",
          },
          card: "hsl(var(--auth-card))",
          "card-border": "hsl(var(--auth-card-border))",
          input: "hsl(var(--auth-input))",
          "input-border": "hsl(var(--auth-input-border))",
          glow: "hsl(var(--auth-glow))",
        },
        // Social providers
